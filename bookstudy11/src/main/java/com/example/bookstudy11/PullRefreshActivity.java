...
import com.example.bookstudy11.constant.ImageList;
import com.example.bookstudy11.util.StatusBarUtil;
import com.example.bookstudy11.util.Utils;
import com.example.bookstudy11.widget.BannerPager;
import com.example.bookstudy11.widget.PullDownRefreshLayout;
...
public class PullRefreshActivity extends AppCompatActivity implements PullDownRefreshLayout.PullRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        params.height = (int) (Utils.getScreenWidth(this) * 250 / 640f);
        //设置广告轮播条的图片列表
