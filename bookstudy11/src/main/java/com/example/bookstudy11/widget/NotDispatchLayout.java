...
public class NotDispatchLayout extends LinearLayout {
    ...
    public NotDispatchLayout(Context context, AttributeSet attrs){ super(context,attrs);}
    ...
    //设置分发监听器
    public void setNotDispatchListener(NotDispatchListener listener){mListener = listener;}
