...
import com.example.bookstudy11.util.PointUtil;
import com.example.bookstudy11.widget.MultipleTouchView;
...
public class ScaleRotateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MultipleTouchView mtv_gesture = findViewById(R.id.mtv_gesture);
        // 设置多点触摸视图的手势滑动监听器
