...
import com.example.bookstudy.widget.BannerPager;
import com.example.bookstudy.widget.SpacesDecoration;

import java.util.ArrayList;
import java.util.List;

import bookstudy09.adapter.MobileGridAdapter;
import bookstudy09.adapter.RecyclerCombineAdapter;
import bookstudy09.adapter.RecyclerGridAdapter;
import bookstudy09.bean.GoodsInfo;
import bookstudy09.bean.NewsInfo;
import bookstudy09.util.Utils;
...
public class DepartmentHomeFragment extends Fragment implements BannerPager.BannerClickListener {
    ...
    private void initGrid() {
        ...
        adapter.setOnItemLongClickListener(adapter);//设置逛个列表的长按监听器
