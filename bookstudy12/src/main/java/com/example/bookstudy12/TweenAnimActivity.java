...
import com.example.bookstudy12.util.Utils;

public class TweenAnimActivity extends AppCompatActivity implements Animation.AnimationListener {
    ...
    private void initTweenAnim() {
        ...
        alphaAnim.setDuration(3000);//动画的播放时长
        alphaAnim.setFillAfter(true);//维持结束画面
        //创建一个平移动画，向左平移100dp
    ...
    private void initTweenSpinner(){
        ArrayAdapter<String> tweenAdapter = new ArrayAdapter<>(this,R.layout.item_select,tweenArray);
    ...
    class TweenSelectedListener implements AdapterView.OnItemSelectedListener{
