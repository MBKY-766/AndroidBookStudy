...
import com.example.bookstudy12.widget.MosaicView;
import com.example.bookstudy12.widget.ShutterView;

public class YingjiActivity extends AppCompatActivity implements Animator.AnimatorListener, Animation.AnimationListener {
    ...
    private void playYingji() {
        ...
        initView();//初始化各种视图
        rl_yingji.addView(view1);//往相对布局中添加一个图像视图
        //构造一个在灰度上变化的属性动画
